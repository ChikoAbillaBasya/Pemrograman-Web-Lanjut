...
class UserController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        $request->validate([
            ...
            // dan bernilai unik di tabel m_user kolom username kecuali untuk user dengan id yang sedang di edit
            'username' => 'required|string|min:3|unique:m_user,username,' . $id . ',user_id',
            'nama'     => 'required|string|max:100',   // nama harus diisi (minimal 5 karakter) dan bisa tidak diisi
